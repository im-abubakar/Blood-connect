    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-description">
          Discover the reasons to choose Blood-Connect for your healthcare needs.
        ...
        <p className="ba-checks ba-check-first">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Blood Request
        </p>
        ...
        <button
          ...
          onClick={handleBookAppointmentClick}
        >
          <FontAwesomeIcon icon={faHeart} /> Request blood
        </button>
      </div>
    </div>
  );
